...
class RegisterScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BadmintonRegisterScreen();
  }
}

// ─── Main Screen ──────────────────────────────────────────────────────────────
class BadmintonRegisterScreen extends StatefulWidget {
  const BadmintonRegisterScreen({super.key});
  @override
  State<BadmintonRegisterScreen> createState() => _BadmintonRegisterScreenState();
}

class _BadmintonRegisterScreenState extends State<BadmintonRegisterScreen>
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Login button
          AppButton(btnText: "Đăng ký", isLoading: false, onTap: _register),
